...
class DB {
 public:
  ...
  ///
  virtual int Scan(const std::string &table, const std::string &start_key, const std::string &end_key,
  ...
  virtual int BatchRead(const std::string &table, const std::vector<std::string> &keys, int batch_num)=0;

  virtual void print_Nettask_takeon()=0;
